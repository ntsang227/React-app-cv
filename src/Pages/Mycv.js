...
function Mycv() {
    ...
    <div class="container">
        ...
        <div class="name">
            ...
            <ul class="contact">
                <li>
                    <span>P</span> +84868612579
                </li>
                <li>
                    <span>E</span> phantai3202.dev@gmail.com
                </li>
                <li>
                    <span>F</span> www.facebook.com/profile.php?id=100051958545269
                </li>
            </ul>
        </div>
        <div class="info">
        ...
        <div class="item">
            ...
            <div class="web">
                https://github.com/taikhoan21212
            </div>
            <div class="location">
                Frond-end Developer
            </div>
        ...
        <div class="item">
            ...
            <div class="facebook">
                https://www.facebook.com/profile.php?id=100051958545269
            </div>
            <div class="location">
                Frond-end Developer
            </div>
